...
#define XCODE_ENABLE 0

#if XCODE_ENABLE
void ImagingScaleData( IplImage * a, char b[] );//Add by Jun Hu 
#endif
...
VBMP *knn_init_nn(Params *p, BITMAP *a, BITMAP *b, VBMP *&ann_sim, PRINCIPAL_ANGLE *pa=NULL, BOOLMAP *mask=NULL);
VBMP *knn_init_dist(Params *p, BITMAP *a, BITMAP *b, VBMP *ann, VBMP *ann_sim, VBMP *ann_prior=NULL, double lambda = 0, int truncated_d = INT_MAX, BOOLMAP *mask = NULL); //Revisited by Jun Hu
void knn_oneway(Params *p, BITMAP *a, BITMAP *b,
				...
				RegionMasks *region_masks, int tiles, PRINCIPAL_ANGLE *pa, int save_first, VBMP *ann_prior=NULL, double lambda = 0, int truncated_d = INT_MAX, BOOLMAP *mask = NULL);//Revisited by Jun Hu, Add Prior Term
...
void knn(Params *p, BITMAP *a, BITMAP *b,
         ...
         RegionMasks *amask=NULL, BITMAP *bmask=NULL,
         int level=0, int em_iter=0, RecomposeParams *rp=NULL, int offset_iter=0, int update_type=0, int cache_b=0,
         RegionMasks *region_masks=NULL, int tiles=-1, PRINCIPAL_ANGLE *pa=NULL, int save_first=0, VBMP *ann_prior=NULL, double lambda = 0, int truncated_d = INT_MAX, BOOLMAP *mask = NULL); //Revisited by Jun Hu
...
void knn_enrich(Params *p, BITMAP *a, BITMAP *b, VBMP *ann, VBMP *ann_sim, VBMP *annd, PRINCIPAL_ANGLE *pa=NULL, VBMP *ann_prior=NULL, double lambda = 0, int truncated_d = INT_MAX, BOOLMAP *mask = NULL); //Revisited by Jun Hu

void knn_enrich3(Params *p, BITMAP *a, BITMAP *b, VBMP *ann, VBMP *ann_sim, VBMP *annd, PRINCIPAL_ANGLE *pa=NULL, VBMP *ann_prior=NULL, double lambda = 0, int truncated_d = INT_MAX, BOOLMAP *mask = NULL); //Revisited by Jun Hu

void knn_enrich4(Params *p, BITMAP *a, BITMAP *b, VBMP *ann, VBMP *ann_sim, VBMP *annd, PRINCIPAL_ANGLE *pa=NULL, VBMP *ann_prior=NULL, double lambda = 0, int truncated_d = INT_MAX, BOOLMAP *mask = NULL); //Revisited by Jun Hu

void knn_inverse_enrich(Params *p, BITMAP *a, BITMAP *b, VBMP *ann, VBMP *ann_sim, VBMP *annd, PRINCIPAL_ANGLE *pa=NULL, BOOLMAP *mask = NULL);

void knn_inverse_enrich2(Params *p, BITMAP *a, BITMAP *b, VBMP *ann, VBMP *ann_sim, VBMP *annd, PRINCIPAL_ANGLE *pa=NULL, VBMP *ann_prior=NULL, double lambda = 0, int truncated_d = INT_MAX, BOOLMAP *mask = NULL); //Revisited by Jun Hu
...
void change_knn(Params *p, BITMAP *a, BITMAP *b, VBMP *&ann, VBMP *&ann_sim, VBMP *&annd, int kp, PRINCIPAL_ANGLE *pa=NULL, VBMP *ann_prior=NULL, double lambda = 0, int truncated_d = INT_MAX); //Revisited by Jun Hu
